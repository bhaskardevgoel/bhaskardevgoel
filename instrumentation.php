...
<center><p class="head2"><p class="font">Insrumentation and Control Engineering	(CSMM)</p></p></center><br><br>
<div class="left">
<center>
...
<tr>
<td><a class="link_2" href="syllabus/ICD-Syllabus-Ist-SEM.docx"><button class="button2">SEM I</button></a></td>
...
<input type="hidden" name="trd" value="10">
