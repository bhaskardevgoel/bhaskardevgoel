...
<body class="back_2">
<form action="login_check_admin.php" method="POST" name="login" onSubmit="return val_chk();">
<div class="container">
<?php
	include('header.php');
	?>
<div class="head_1"><br><br>
<center><p class="head2"><p class="font"><b>Admin</b> Sign In</p></p></center>
<div >
<center><br><br><br>
...
<center>
<input class="box_1" type="text" name="username" placeholder="Username" size="40"  required><br>
</center>
</td></tr>
...
<tr><td><br><br>
<pre class="next">			   <input type="submit" class="button2" value="Proceed"></pre>
</td></tr>
</table>
</center>
</center>
